...
from transformers import AutoModelForCausalLM, BitsAndBytesConfig, set_seed, AutoConfig
...
class Actor(nn.Module):
    ...
    def forward(
        ...
        #         print(f"change {k} from dtype torch.float32 to {self.model.get_input_embeddings().weight.dtype}")
        ####
